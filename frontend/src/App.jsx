              ...
              <div className="flex gap-6">
                ...
                <div className="flex-1 min-w-0 space-y-6">
                  <div>
                    ...
                    <p className="text-sm mt-1" style={{ color: "#6B7280" }}>
                      Manage your knowledge base. All uploaded documents are automatically chunked
                      and indexed for high-precision retrieval during research sessions.
                    </p>
                  </div>
                  <UploadArea onUploadComplete={() => {}} />
                  <DocumentLibrary documents={documents} onDelete={() => {}} />
                </div>
                ...
                <div className="w-64 shrink-0 space-y-4">
                  ...
                  <div className="rounded-xl p-5 text-white" style={{ background: "#0D1B3E" }}>
                    <p className="text-[10px] font-semibold tracking-widest uppercase mb-4" style={{ color: "#9CA3AF" }}>
                      System Health
                    </p>
                    <p className="text-4xl font-bold">—</p>
                    <p className="text-[10px] tracking-widest uppercase mt-1 mb-4" style={{ color: "#9CA3AF" }}>Storage Capacity</p>
                    <div className="h-1 rounded-full mb-4" style={{ background: "#1E3A6E" }}>
                      <div className="h-1 rounded-full w-0" style={{ background: "#EEF2FF" }} />
                    </div>
                    <div className="flex justify-between">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] tracking-wider uppercase" style={{ color: "#9CA3AF" }}>Chunks</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-xl p-4 bg-white border border-gray-200">
                    ...
                    <p className="text-xs leading-relaxed" style={{ color: "#6B7280" }}>
                      {documents.length === 0
                        ...
                        : `${documents.filter(d => d.status === "indexed").length} of ${documents.length} documents indexed and ready for search.`}
                    </p>
                  </div>
                </div>
              </div>
...
function TabButton({ active, onClick, children }) {
  return (
    ...
    >
      {children}
      {active && (
        <span className="absolute bottom-0 left-0 right-0 h-0.5 rounded-full" style={{ background: "#003499" }} />
      )}
    </button>
  )
}
